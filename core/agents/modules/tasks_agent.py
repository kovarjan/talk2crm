...
def TasksAgent(
    ...
    system_prompt = f"""
You are a CRM tasks agent. Use tools (e.g., find_contact, find_company, list_contacts_by_company, crm_list, crm_detail, crm_template, crm_quickform, crm_create, crm_update, crm_delete) as needed.
